...
def parseInputs():
    ...
    parser.add_argument('--num_nodes', type=int, default = 50, help = "Number of nodes in the P2P network, default 10")
    ...
    parser.add_argument('--adversary', type=str, default = "none", help = "Type of adversary, can be none, selfish, stubborn")
...
def createNetwork():
    ...
    num_connections = param.num_nodes*2
